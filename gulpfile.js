...
/**
 * 0. Change/adapt name of your library
 */
const moduleName = 'ng-plugin-starter';

/**
 * 0. Add libraries where are externally available after consuming the plugin
 */
const externals = [
    '@angular/animation',
    '@angular/common',
...
gulp.task('rollup:fesm', function () {
    return gulp.src(`${buildFolder}/**/*.js`)
        .pipe(rollup({
            ...
            // Load plugins for transformation
            // See "plugins" in https://rollupjs.org/#core-functionality
            plugins: [
                resolve(),
                uglify(),
            ],
